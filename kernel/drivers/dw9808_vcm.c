...
/*
 * Dongwoon DW9808 VCM support, shared across the Galaxy Tab S9 family.
 *
 * Copied verbatim from ubuntu-galaxy-tab-s9ultra's own dw9808_vcm.c
 * (SM-X910 Ultra) -- this is a plain chip driver with no board-specific
 * data, reused for X716B's own rear-camera autofocus actuator on the
