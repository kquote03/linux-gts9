 ...
 *
 * Ported verbatim from gts9wifi-fedora (kernel/files/wacom-wez01.c there)
 * for the X716B (5G) pivot -- unmodified content, only this project's
 * usual out-of-tree file-naming convention applied (matching
 * touchscreen-fts1ba90a-x716.c/panel-samsung-ana38407-x716.c). Digitizer
 ...
 * epen_int_default comment) -- not yet real-hardware-tested for actual
 * pen input, since the IC/protocol itself is assumed identical to X710's
 * per the "gts9" (not model-specific) firmware naming, not independently
