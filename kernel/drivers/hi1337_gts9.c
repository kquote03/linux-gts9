...
static const struct of_device_id hi1337_of_match[] = {
	{ .compatible = "hynix,hi1337-gts9-rear", .data = &hi1337_rear },
	{ .compatible = "hynix,hi1337-gts9-front", .data = &hi1337_front },
	{ }
};
...
MODULE_DESCRIPTION("Hynix HI1337 driver for Samsung SM-X716B camera modules");
MODULE_LICENSE("GPL");
